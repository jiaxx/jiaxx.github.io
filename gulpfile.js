...
gulp.task('img_people', function() {
  return gulp.src('_img/people/*.{png,jpg}')
    .pipe($.responsive({
      // For all the images in the folder
      '*': [{
        width: 230,
...
gulp.task('img_research', function() {
  return gulp.src('_img/research/*.{png,jpg}')
    .pipe($.responsive({
      // For all the images in the folder
      '*': [{
        width: 230,
    ...
    .pipe(imagemin())
    .pipe(gulp.dest('assets/img/research/'));
});
